...
<p align="center">
  ...
  [![Tests](https://img.shields.io/badge/pytest-3078%20passed-brightgreen)]()
  [![MCP](https://img.shields.io/badge/MCP-Server%2BClient-blueviolet)]()
</p>

> **deadman** is a conversation-first AI copilot that walks families through **end-of-life preparation and after-death procedures** — wills &amp; digital legacy, funeral logistics, medical navigation, grief companionship, and more. **Type or speak your need and the agent guides you through it** — no need to click through pages. It also lets you **customize folk-custom rules** (funeral / wedding / memorial rituals) and visualize your **family tree (kinship graph)**.

> **For organizations (To B):** deadman ships as a **multi-tenant platform** — agencies (funeral services, insurance, legal, aftercare) get an **org workbench** (`/org`) with customers, cases, audit logs, knowledge base, team roles, **license-based licensing** (30-day trial, read-only on expiry), and **data export** (CSV/JSON/zip). Tenant data isolation via `resolve_tenant_path()` keeps every tenant's data separate.
...
- **10-layer clean architecture**, `3078` passing tests, zero shells.
