...
_INTENT_KEYWORDS: dict[IntentType, tuple[str, ...]] = {
    IntentType.WILL: (
        "遗嘱", "遗书", "终活笔记", "身后事安排", "财产分配", "分配财产",
        "立遗嘱", "公证遗嘱", "自书遗嘱", "遗赠", "继承安排",
    ),
    IntentType.FUNERAL: (
        "死亡证明", "户口注销", "销户", "丧葬", "火化", "火葬", "殡仪",
        "丧葬费", "丧葬补助金", "社保丧葬", "公积金提取", "殡葬", "办手续",
        "去世手续", "死后怎么办", "遗体",
    ),
    IntentType.GRIEF: (
        "好难过", "想他", "想她", "舍不得", "思念", "崩溃", "走不出来",
        "心里空", "陪我", "倾诉", "太想", "怀念", "难过",
    ),
    IntentType.DIGITAL_LEGACY: (
        "数字遗产", "账号", "密码", "加密货币", "虚拟资产", "微信账号",
        "支付宝", "游戏账号", "数字资产", "云盘", "会员账号", "社交账号",
    ),
    IntentType.DEAD_SWITCH: (
        "死人开关", "定时", "如果我走了", "万一我不在", "自动发送",
        "定时发送", "遗言自动", "不在了就", "身后自动",
    ),
    IntentType.MEMORIAL: (
        "悼文", "讣告", "墓志铭", "答谢词", "追思", "纪念文", "缅怀",
        "追悼词", "生平", "纪念文章",
    ),
    IntentType.KNOWLEDGE: (
        "法律", "规定", "政策", "继承法", "民法典", "可以吗", "是否合法",
        "怎么算", "有权", "法条", "条例", "规定是", "咨询",
    ),
}
